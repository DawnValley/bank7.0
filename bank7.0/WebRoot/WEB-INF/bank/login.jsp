...
<script language="javascript">
	...
	{
		var url = "<%=path%>/RegisterLoginController.do?method=registerPage";
	...
	<form name="LoginForm" action="RegisterLoginController.do?method=login" method="post">
		<div class="formStyle">
			...
			<div class="languageStyle1">
				<div>
	            <input type="radio" name="role" id="role" value="0" /><spring:message code="bank.login.radio.administrator"/>
	                    &nbsp;&nbsp;&nbsp;
	            <input type="radio" name="role" id="role" value="1" checked/><spring:message code="bank.login.radio.user"/>
                </div>    
                <!-- 国际化切换 -->
