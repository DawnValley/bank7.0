...
<script language="javascript">
    ...
    /*首页*/
    function topPage() {
        window.self.location = "AdministratorAction.do?command=logManagementInfo&pageNo=${pageMode.topPageNo}&pageSize=${pageMode.pageSize}&queryStr=${queryStr}&type=${type}";
    }
    /*上一页*/
    function previousPage() {
        window.self.location = "AdministratorAction.do?command=logManagementInfo&pageNo=${pageMode.previousPageNo}&pageSize=${pageMode.pageSize}&queryStr=${queryStr}&type=${type}";
    }
    /*下一页*/
    function nextPage() {
        window.self.location = "AdministratorAction.do?command=logManagementInfo&pageNo=${pageMode.nextPageNo}&pageSize=${pageMode.pageSize}&queryStr=${queryStr}&type=${type}";
    }
    /*尾页*/
    function bottomPage() {
        window.self.location = "AdministratorAction.do?command=logManagementInfo&pageNo=${pageMode.bottomPageNo}&pageSize=${pageMode.pageSize}&queryStr=${queryStr}&type=${type}";
    }
</script>
</head>
...
<center>
<div class="all">
    <form action="AdministratorAction.do?command=logManagementInfo&pageNo=1&pageSize=${pageMode.pageSize}" name="queryForm" method="post">
        <div class="div1">  
            <div>
	            ...
	            <input type="reset" class="input" value="<bean:message key="bank.business_public.button.reset"/>"/><!-- 重置 -->
            </div>
