...
<body>
<div class="middle">
	<form name="depositForm" action="BankBusinessAction.do?command=withDrawals" method="post" class="form">
			<div class="div1">
				<span style="font-size: 20px"><bean:message key="bank.withDrawals.text.withDrawals_money"/></span><!-- 取款金额： -->
