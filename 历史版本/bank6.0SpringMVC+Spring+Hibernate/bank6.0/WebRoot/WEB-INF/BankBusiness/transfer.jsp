...
<div class="middle">
		<form name="transferForm" action="BankBusinessController.do?method=transfer" method="post">
			<div class="div1">
				<span style="font-size: 20px"><spring:message code="bank.transfer.text.account"/><!-- 对方账户名： --></span>
				<input type="text" name="toName" class="input1">
			</div>
			<div class="div2">
				<span style="font-size: 20px"><spring:message code="bank.transfer.text.transfer_money"/><!-- 转账金额： --></span>
